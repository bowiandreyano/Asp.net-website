<%@ Page Language="C#" AutoEventWireup="true" CodeFile="overview.aspx.cs" Inherits="linklogin" %>
...
<nav class="w3-sidenav w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidenav"><br>
  ...
  <a href="overview.aspx" class="w3-padding w3-blue"><i class="fa fa-users fa-fw"></i>  Overview</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-container">
      <h1>  WELOCOME</h1>
      <a href="FrontEnd/CustomerLogin/index.aspx" target="_blank">SLIDE SHIFU</a>
  </div>

  <!-- Footer -->
  <footer class="w3-container w3-padding-16 w3-light-grey">
    
    <p>Powered by <a href="http://www.w3schools.com/w3css/default.asp" target="_blank">SS Team</a></p>
  </footer>
