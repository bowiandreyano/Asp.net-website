<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ordersupdates.aspx.cs" Inherits="linklogin" %>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-container w3-responsive w3-rest" >
    ...
    <div>
    <table cellpadding="10" runat="server">
            <tr>
                <td>ID</td>
                <td>
  ...
  <footer class="w3-container w3-padding-16 w3-light-grey">
    ...
    <p>Powered by <a href="http://www.w3schools.com/w3css/default.asp" target="_blank">Slides Shifu</a></p>
  </footer>
