...
body, html {
    ...
    .bgimg-1 {
        ...
        background-image: url("/FrontEnd/img/bg-head.JPG");
        min-height: 100%;
    }
.boximg{
    float: left;
...
<div class="w3-top">
  <ul class="w3-navbar w3-white w3-card-2" id="myNavbar">
    <li>
      <a href="#home" class="w3-wide">SlideShifu</a>
    </li>
...
<!-- Work Section -->
<div class="w3-container w3-padding-128" id="portofolio" runat="server">
  <h3 class="w3-center">OUR WORK</h3>
  <p class="w3-center w3-large">What we've done for people</p>

  <div class="w3-row-padding" style="margin-top:64px" runat="server">
...
<%--<div class="w3-container w3-padding-128 w3-light-grey" id="contact">
  ...
  <div class="w3-row-padding" style="margin-top:64px">
    <div class="w3-half">
      <p><i class="fa fa-map-marker fa-fw w3-xxlarge w3-margin-right"></i> Universitas Indonesia, Indonesia</p>
      <p><i class="fa fa-phone fa-fw w3-xxlarge w3-margin-right"></i> Phone: +6212901511172</p>
      <p><i class="fa fa-envelope fa-fw w3-xxlarge w3-margin-right"> </i> Email: bowiandreyano@gmail.com</p>
      <br />
    </div>
    <div class="w3-half">
      <!-- Add Google Maps -->
...
<script>
<!-- Google Map Location -->
    var myCenter = new google.maps.LatLng(-6.362449, 106.825031);
