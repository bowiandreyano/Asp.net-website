<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminCustomerData.aspx.cs" Inherits="linklogin" %>
...
<nav class="w3-sidenav w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidenav"><br>
  ...
  <a href="Customer.aspx" class="w3-padding w3-blue"><i class="fa fa-bell fa-fw"></i>  Customer</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-container" runat="server">
      <asp:TextBox ID="TextBox4" runat="server" placeholder="Type the Username Please" CssClass="w3-container">
