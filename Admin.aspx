<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin.aspx.cs" Inherits="linklogin" %>
...
<nav class="w3-sidenav w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidenav"><br>
  ...
  <a href="Admin.aspx" class="w3-padding w3-blue"><i class="fa fa-users fa-fw"></i>  Admin</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-container">
      <a href="AdminAdminRegister.aspx" <button class="w3-btn-block">Add Admin</button> </a><br><br />
      <a href="AdminAdminData.aspx" <button class="w3-btn-block">View Admin</button> </a><br><br />
  </div>

  <!-- Footer -->
  <footer class="w3-container w3-padding-16 w3-light-grey">
    <h4>2017</h4>
    <p>Powered by <a href="http://www.w3schools.com/w3css/default.asp" target="_blank">SlideShifu</a></p>
  </footer>
